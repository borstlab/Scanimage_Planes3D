...
% channel images, merge, etc out of SI core.)
    ...
    properties (Constant)        
        ...
        prettyColorMapSpecs = scanimage.components.acq.ChannelImageHandler.colorMapSpecs(:,1);
    ...
    methods
        ...
        function initColorMapsInTable(obj)
            pms = scanimage.components.acq.ChannelImageHandler.prettyColorMapSpecs{1};
            obj.updateTable(pms);
        end
