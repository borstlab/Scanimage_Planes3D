...
%             end
    ...
    methods (Access = protected, Hidden)
        function val = accessScannersetPostGet(obj,~)
            ...
            assert(~isempty(obj.mdfData.zGalvoAngularRange),'zGalvoAngularRange is not defined in machine data file');
            piezo = scanimage.mroi.scanners.Galvo(...
                obj.mdfData.zGalvoAngularRange,...
                obj.mdfData.voltsPerOpticalDegreeZ,...
                obj.flytoTimePerScanfield,...
                obj.flybackTimePerFrame,...
