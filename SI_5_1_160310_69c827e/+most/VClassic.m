classdef VClassic < hgsetget
    ...
    methods (Access=protected)
        ...
        function pdepPropGetDisallow(obj,src,evnt)                 
            ...
            most.idioms.dispError('Specified property (%s) does not exist or cannot be accessed for objects of class %s\n',propName,class(obj));
        ...
        function pdepPropSetDisallow(obj,src,evnt)      
            ...
            most.idioms.dispError('Specified property (%s) does not exist or cannot be set for objects of class %s\n',propName,class(obj));           
        ...
        function printErrorMessage(obj, src, ME)
           most.idioms.dispError('WARNING(%s): Unable to set property ''%s'' because of following error:\n\t%s\n',class(obj),src.Name,ME.message);
