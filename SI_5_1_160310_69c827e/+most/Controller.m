classdef Controller < most.DClass & most.HasClassDataFile
            ...
            for i=1:length(propNames)
                ...
                if any(strfind(fullPropName,[SubMdlName '.']) == 1)
                    ...
                    if isfield(pbinding,'Callback')
                        ...
                        obj.hCallbackPostSetListeners.(fullPropName_) = addlistener(hMdl,pname,'PostSet',@(src,evnt)obj.dispatchCallback(src,evnt,pbinding.Callback));
