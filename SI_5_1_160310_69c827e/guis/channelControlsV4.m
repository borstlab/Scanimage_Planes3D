...
% Last Modified by GUIDE v2.5 22-Apr-2015 10:40:34
...
handles.pcChannelConfigg = most.gui.control.ColumnArrayTable(findobj(hObject,'Tag','tblChanConfigg'));

% initialize pmImageColorMap and colormaps in table
prettyColorMapSpecs = scanimage.components.acq.ChannelImageHandler.prettyColorMapSpecs;
set(handles.pmImageColormap,'String',[prettyColorMapSpecs(:);{'Custom'}]);
set(handles.pmImageColormap,'Value',1);
handles.channelImageHandler = scanimage.components.acq.ChannelImageHandler(handles.pcChannelConfigg,handles.tblChanConfigg);
...
function tblChanConfigg_CellEditCallback(hObject, eventdata, handles)
% hObject    handle to tblChanConfigg (see GCBO)
