...
% Last Modified by GUIDE v2.5 24-Mar-2015 10:51:51
...
% --- Executes on button press in cbLockVolume.
function cbLockVolume_Callback(hObject, eventdata, handles)
% hObject    handle to cbLockVolume (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of cbLockVolume
handles.hController.updateModel(hObject,eventdata,handles);
...
% --- Executes on button press in cbUseAll.
function cbUseAll_Callback(hObject, eventdata, handles)
% hObject    handle to cbUseAll (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of cbUseAll
handles.hController.updateModel(hObject,eventdata,handles);
