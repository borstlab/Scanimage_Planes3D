    ...
    methods 
        function obj = GenericPmtController(hSI)
            ...
            try
                ...
                if ~isempty(obj.mdfData.pmtDaqGainAOChannels)
                ...
                if ~isempty(obj.mdfData.pmtDaqTrippedDIChannels)
                ...
                if ~isempty(obj.mdfData.pmtDaqPowerDOChannels)
                ...
                if ~isempty(obj.mdfData.pmtDaqTripResetDOChannels)
