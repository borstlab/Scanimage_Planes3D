...
pmtDevAdresses = {[] [] [] []};     % Numeric serial number or string VISA addresses of USB PMT controllers. For each of 4 PMTs leave empty if controlled by ECU or enter address
