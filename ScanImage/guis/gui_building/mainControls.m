...
% --- Executes on slider movement.
function ZAbsoluteSlider_Callback(hObject, eventdata, handles)
% hObject    handle to ZAbsoluteSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function ZAbsoluteSlider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ZAbsoluteSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ZAbsolute_Callback(hObject, eventdata, handles)
...
% --- Executes on slider movement.
function YRelativeSlider_Callback(hObject, eventdata, handles)
% hObject    handle to YRelativeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function YRelativeSlider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to YRelativeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function YRelative_Callback(hObject, eventdata, handles)
% hObject    handle to YRelative (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of YRelative as text
%        str2double(get(hObject,'String')) returns contents of YRelative as a double
updateScanParameter(hObject);


% --- Executes during object creation, after setting all properties.
function YRelative_CreateFcn(hObject, eventdata, handles)
% hObject    handle to YRelative (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function XRelativeSlider_Callback(hObject, eventdata, handles)
% hObject    handle to XRelativeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function XRelativeSlider_CreateFcn(hObject, eventdata, handles)
% hObject    handle to XRelativeSlider (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function XRelative_Callback(hObject, eventdata, handles)
% hObject    handle to XRelative (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of XRelative as text
%        str2double(get(hObject,'String')) returns contents of XRelative as a double
updateScanParameter(hObject);


% --- Executes during object creation, after setting all properties.
function XRelative_CreateFcn(hObject, eventdata, handles)
% hObject    handle to XRelative (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
